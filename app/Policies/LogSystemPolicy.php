...
class LogSystemPolicy
{
     ...
     */
    public function view(User $user, LogSystem $model): bool
    {
        if ($user->user_group_id === 0) {
            return true;
        }
     ...
     */
    public function update(User $user, LogSystem $model): bool
    {
        if ($user->user_group_id === 0) {
            return true;
        }
     ...
     */
    public function delete(User $user, LogSystem $model): bool
    {
        if ($user->user_group_id === 0) {
            return true;
        }
     ...
     */
    public function restore(User $user, LogSystem $model): bool
    {
        if ($user->user_group_id === 0) {
            return true;
        }
     ...
     */
    public function forceDelete(User $user, LogSystem $model): bool
    {
        if ($user->user_group_id === 0) {
            return true;
        }
